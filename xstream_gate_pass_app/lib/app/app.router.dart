...
import 'package:xstream_gate_pass_app/core/enums/filestore_type.dart' as _i25;
...
class GatePassEditViewArguments {
  ...
  final _i24.GatePassAccess gatePass;
...
class CameraCaptureViewArguments {
  ...
  final _i25.FileStoreType fileStoreType;
...
extension NavigatorStateExtension on _i26.NavigationService {
  ...
  Future<dynamic> navigateToGatePassEditView({
    _i23.Key? key,
    required _i24.GatePassAccess gatePass,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToCameraCaptureView({
    ...
    required _i25.FileStoreType fileStoreType,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
