...
class BackgroundJobInfo {
  BackgroundJobInfo({required this.id, this.refTransactionId = 0, this.stopId = 0, required this.jobArgs, this.tryCount = 0, required this.lastTryTime, required this.nextTryTime, required this.creationTime, this.isAbandoned = false, this.errorMessage = "", required this.jobType});
