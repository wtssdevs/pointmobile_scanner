...
class AppConst {
  ...
  static const String cms_currentLoginInformation =
      "cms_currentLoginInformation";
  static const String cms_currentLoginInformationRefreshedAt =
      "cms_currentLoginInformationRefreshedAt";
  static const String cms_defaultInspectionDepotId =
      "cms_defaultInspectionDepotId";
  ...
  static const String CmsGetAllInspectionLocationsPagedEdit =
      "/api/InspectionLocations/GetAllPagedEdit";
  static const String CmsGetAllInspectionActionsPagedEdit =
      "/api/InspectionActions/GetAllPagedEdit";
  static const String CmsGetAllInspectionDamagesPagedEdit =
      "/api/InspectionDamages/GetAllPagedEdit";
  static const String CmsGetAllInspectionItemsPagedEdit =
      "/api/InspectionItems/GetAllPagedEdit";
  static const String CmsGetAllItemCodesPagedEdit =
      "/api/LoadItemCodes/GetAllItemCodes";
  static const String CmsGetInspectableContainers =
      "/api/services/app/MobileInspections/GetInspectableContainers";
  static const String CmsStartInspectionForContainer =
      "/api/services/app/MobileInspections/StartInspectionForContainer";
  static const String CmsGetInspectionForEdit =
      "/api/services/app/MobileInspections/GetInspectionForEdit";
  static const String CmsSaveInspection =
      "/api/services/app/MobileInspections/SaveInspection";
  static const String CmsCompleteInspection =
      "/api/services/app/MobileInspections/CompleteInspection";
  static const String CmsSetInspectionRepairDatesNow =
      "/api/services/app/MobileInspections/SetRepairDatesNow";
  static const String CmsInspectionLinePhotoUpload =
      "/api/mobile/inspections/files/upload";
  static const int CmsInspectionLinePhotoMaxBytes = 8388608;
  static const int CmsInspectionLinePhotoUploadConcurrency = 2;

  static String cmsInspectionLinePhotosForLine(int inspectionLineId) =>
      "/api/mobile/inspections/files/line/$inspectionLineId";

  static String cmsInspectionLinePhotoDownload(int documentId) =>
      "/api/mobile/inspections/files/download/$documentId";

  static String cmsInspectionLinePhotoDelete(int documentId) =>
      "/api/mobile/inspections/files/$documentId";
