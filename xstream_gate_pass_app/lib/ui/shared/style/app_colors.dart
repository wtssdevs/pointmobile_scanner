...
const Color kcPrimaryColor = Color.fromARGB(255, 7, 53, 83);
const Color kcSecondaryColor = Color(0xFF006684);
...
MaterialColor kcPrimarySwatchColor = MaterialColor(Colors.white.value, color);
