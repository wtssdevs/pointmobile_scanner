...
mixin $LoginView on StatelessWidget {
  ...
  void _updateFormData(FormViewModel model, {bool forceValidate = false}) {
    model.setData(
      model.formValueMap
        ..addAll({
          TenantCodeValueKey: tenantCodeController.text,
...
extension ValueProperties on FormViewModel {
  ...
  String? get tenantCodeValidationMessage =>
      this.fieldsValidationMessages[TenantCodeValueKey];
